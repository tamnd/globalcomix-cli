...
// HTTP behaviour is covered in globalcomix_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "globalcomix://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("globalcomix", "about")
	if err != nil || got.String() != "globalcomix://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want globalcomix://page/about", got.String(), err)
	}
}
