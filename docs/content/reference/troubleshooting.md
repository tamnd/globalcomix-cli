...
Most of these come down to network reality or how globalcomix serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

globalcomix rate-limits like any public site. gc already paces
...
Where a surface is gated, gc reads a cookie or token you supply
...
`gc`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what gc actually did
