---
title: "gc"
description: "Browse GlobalComix comics catalog"
heroTitle: "globalcomix, from the command line"
heroLead: "Browse GlobalComix comics catalog One pure-Go binary, no API key, output that pipes into the rest of your tools, and a resource-URI driver other programs can address."
...
gc links <path>           # the pages it links to, each addressable
gc serve --addr :7777     # the same operations over HTTP
```
...
- **As a command** for reading globalcomix by hand or in a script. Start with
  the [quick start](/getting-started/quick-start/).
- **As a resource-URI driver** so a host like
  [ant](https://github.com/tamnd/ant) can address globalcomix as
  `globalcomix://` URIs and follow links across sites. See
